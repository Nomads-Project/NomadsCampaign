version = 3
ScenarioInfo = {
    name = 'Nomads Campaign Mission 2',
    description = 'TODO',
    type = 'campaign_coop',
    starts = true,
    preview = '',
    ...
    norushoffsetX_UEF_Disabled = 0.000000,
    norushoffsetY_UEF_Disabled = 0.000000,
    norushoffsetX_Cybran = 0.000000,
    norushoffsetY_Cybran = 0.000000,
    norushoffsetX_Nomad_Reinforcements = 0.000000,
    norushoffsetY_Nomad_Reinforcements = 0.000000,
